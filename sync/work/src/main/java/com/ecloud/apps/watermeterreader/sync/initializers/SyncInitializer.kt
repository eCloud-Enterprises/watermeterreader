package com.ecloud.apps.watermeterreader.sync.initializers
...
import com.ecloud.apps.watermeterreader.sync.workers.SyncWorker
...
/**
 * Registers work to sync the data layer periodically on app startup and when selected url is set.
 */
